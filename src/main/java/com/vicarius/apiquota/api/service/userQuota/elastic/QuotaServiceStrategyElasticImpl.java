package com.vicarius.apiquota.api.service.userQuota.elastic;
...
@Slf4j
//@AllArgsConstructor
public class QuotaServiceStrategyElasticImpl implements QuotaServiceStrategy {
    private final UserQuotaRepository userQuotaRepository;
    private final UserQuotaMapper userQuotaMapper;

    public QuotaServiceStrategyElasticImpl(UserQuotaRepository userQuotaRepository, UserQuotaMapper userQuotaMapper) {
